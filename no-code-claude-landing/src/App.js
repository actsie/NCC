  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        <div className="sticky top-0 h-screen flex flex-col items-center justify-center bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="sticky top-0 h-screen flex flex-col items-center justify-center bg-[#F8FAFC] py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
      ...
      <section className="px-6 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="bg-[#0D9488] p-4 rounded-full w-16 h-16 mx-auto mb-6 flex items-center justify-center">
